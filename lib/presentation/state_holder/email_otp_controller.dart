...
class EmailOtpVerifactionController extends GetxController {
  ...
  Future<bool> getEmailVerifactionOtp(String email,String otp) async {
    bool isSuccess = false;
    _inprogress=true;
    update();

    final NetWorkResponse response =
    await NetWorkCaller.postRequest(url: Urls.emailsOtp(email,otp));
